...
class TaskController extends \yii\web\Controller
{
    ...
    public function actionFreshStatus()
    {
        ...
        return HttpResponse::packReturn(0, 'success', [
        		...
        		'lastScoreTime' => date('Y-m-d H:i:s', $dailyStatus['last_score_time']),
        		'clickCount' => $dailyStatus['click_count'],
        		'lastClickTime' => date('Y-m-d H:i:s', $dailyStatus['last_click_time']), 
    ...
    public function actionListTask() {
    	...
    	foreach ($statusArr as $status) {
    		$ret['statusArr'][] = [
    				...
    				'date' => $date, 
    				'score' => $status['score'], 
    				'lastScoreTime' => date('Y-m-d H:i:s', $status['last_score_time']), 
    				'clickCount' => $status['click_count'],
    				'lastClickTime' => date('Y-m-d H:i:s', $status['last_click_time']),
